    ...
    private void initListeners() {
        ...
        expandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v,
                ...
                switch (selected) {
                    case "Dhaka":
                        intent = new Intent(ZoneActivity.this, DoctorsreferenceActivity.class);
                        startActivity(intent);
                        break;
                    case "Bhola":
                        intent = new Intent(ZoneActivity.this, DoctorrefbholaActivity.class);
                        startActivity(intent);
                        break;
                    case "Chittagong":
                        intent = new Intent(ZoneActivity.this, DoctorrefchittagongActivity.class);
                        startActivity(intent);
                        break;
                    case "Sylhet":
                        intent = new Intent(ZoneActivity.this, DoctorrefsylhetActivity.class);
                        startActivity(intent);
                        break;
                    case "Barisal":
                        intent = new Intent(ZoneActivity.this, DoctorrefbarisalActivity.class);
                        startActivity(intent);
                        break;
